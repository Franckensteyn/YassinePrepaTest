...
-- -----------------------------------------------------
-- Table `yassineprepatest`.`images`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yassineprepatest`.`images` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `yassineprepatest`.`images_has_news`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yassineprepatest`.`images_has_news` (
  ...
  CONSTRAINT `fk_images_has_news_images1`
    ...
    REFERENCES `yassineprepatest`.`images` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_images_has_news_news1`
    FOREIGN KEY (`news_id`)
    REFERENCES `yassineprepatest`.`news` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
